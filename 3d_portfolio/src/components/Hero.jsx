    ...
    <section className='relative w-full h-screen mx-auto'>
      <div className={
        ...
        <div>
          ...
          }>Hi, I'm <span className='text-[#915eff]'>Sagnik</span></h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I develop Cloud Native Applications, User  <br className='sm:block hidden' /> Interface and Web applications for fun.
          </p>
        </div>
      </div>
      <ComputersCanvas />
