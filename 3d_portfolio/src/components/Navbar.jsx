    ...
    >
      ...
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        ...
        >
          ...
          <p className='text-white text-[18px] font-bold cursor-pointer flex'>Sagnik&nbsp;
        ...
        <div className='sm:hidden flex flex-1 justify-end items-center'>
          ...
          <div className={
            `${!toggle ? 'hidden' : 'flex'} p-6 absolute top-20 right-0 mx-4 my-2 min-[140px] z-10 rounded-xl black-gradient`
          }>
